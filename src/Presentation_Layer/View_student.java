...
public class View_student extends JFrame {
	...
	private View_validator valid=null;
	...
	public View_student() {
		...
		btnViewGrades_s.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				table_1=st.findGrades(st.getId());
		...
		btnNewButton_1s.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
				st.setcnp(cnp_s.getText());
				st.setname(name_s.getText());
				st.updateById();}
				else
					valid=new View_validator();
		...
		btnEnroll_s.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				enr.enroll(st.getId(),Integer.parseInt(id_course_s.getText()));
			}
		...
		btnNewButton_3s.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				enr.deleteEnroll(st.getId(),Integer.parseInt(id_course_s.getText()));
			}
		});
