...
public class View_admin extends JFrame {
	...
	public View_admin() {
		...
		btnNewButton_t.addActionListener(new ActionListener() {
			...
			panel_t.removeAll();
			table=tc.findMyCourse(tc.getid());
			panel_t.add(table);
			panel_t.updateUI();
			}
		});
		...
		btnNewButton_2t.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				enr.updateGrade(Integer.parseInt(id_student_t.getText()),Integer.parseInt(id_course_t.getText()),Integer.parseInt(grade_t.getText()));
				panel_t.removeAll();
				table=tc.findStudents(Integer.parseInt(id_course_t.getText()));
				panel_t.add(table);
				panel_t.updateUI();
		...
		add_course_t.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				id_c++;
				enr.createCourse(id_c, date_t.getText(), course_name_t.getText(), tc.getid());
			}
		});
		...
		find_date.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				panel_t.removeAll();
				table=tc.findByDate(start_date.getText(), end_date.getText(),Integer.parseInt(id_student_t.getText()));
				panel_t.add(table);
				panel_t.updateUI();
			}
		});
